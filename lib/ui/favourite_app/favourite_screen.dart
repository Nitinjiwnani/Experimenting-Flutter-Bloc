  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          BlocBuilder<FavouriteAppBloc, FavouriteAppStates>(
        ...
        switch (state.listStatus) {
          ...
          case ListStatus.sucess:
            return ListView.builder(
              itemCount: state.favouriteItenList.length,
              itemBuilder: (context, index) {
                final item = state.favouriteItenList[index];
                return Card(
                  child: ListTile(
                    ...
                    trailing: IconButton(onPressed: (){
                      FavouriteItemModel itemModel = FavouriteItemModel(id: item.id, value: item.value, isFavourite: item.isFavourite ? false : true, isDeleting: item.isDeleting ? false : true);
                      context.read<FavouriteAppBloc>().add(FavouriteItem(item: itemModel));
                    }, icon: Icon(
